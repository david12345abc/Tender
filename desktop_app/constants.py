...
APP_TITLE = "Подача заявок на тендер"
...
TENDER_DOCUMENTS_ROOT = Path(r"\\192.168.1.198\Files\9.ТД\Архив\Тендерный отдел\Документация")
...
COLUMNS: list[tuple[str, str]] = [
    ...
    ("date_end_registration", "Прием заявок до"),
    ("total_price", "НМЦ"),
