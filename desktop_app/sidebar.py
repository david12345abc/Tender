...
class Sidebar(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.ed_quick_search = self._make_line("Поиск по ключевым словам...")
        self.ed_quick_search.setMinimumWidth(360)
        self.ed_quick_search.setMinimumHeight(44)
        self.ed_quick_search.setMaximumHeight(44)
        quick_row.addWidget(self.ed_quick_search, 2)
        self.cb_quick_trend = QuickMultiSelect(list(PROCEDURE_TYPE_OPTIONS))
        quick_row.addWidget(self._quick_filter_box("Тип процедуры", self.cb_quick_trend, 140), 1)
        self.cb_quick_status = QuickMultiSelect(list(STATUS_OPTIONS))
        quick_row.addWidget(self._quick_filter_box("Статус", self.cb_quick_status, 125), 1)
        self.cb_quick_law = QuickMultiSelect([("44-ФЗ", "44"), ("223-ФЗ", "223")])
        quick_row.addWidget(self._quick_filter_box("Закон", self.cb_quick_law, 105), 1)
        ...
        quick_row.addWidget(self._quick_filter_box("Дата публикации", self.cb_quick_published, 135), 1)
        self.cb_browser = ChevronComboBox()
        self.cb_browser.setObjectName("QuickFilterCombo")
        self.cb_browser.setMinimumWidth(160)
        self.cb_browser.setMinimumHeight(28)
        self.cb_browser.setMaximumHeight(30)
        ...
        quick_row.addWidget(self._quick_filter_box("Браузер", self.cb_browser, 160), 1)
        ...
        self.btn_search.setMinimumWidth(96)
