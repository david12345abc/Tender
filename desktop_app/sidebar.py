...
class Sidebar(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        sections_row.setAlignment(Qt.AlignBottom)
        ...
        main_group_lay.setSpacing(8)
        main_group_lay.setAlignment(Qt.AlignBottom)

        self.cb_quick_trend = QuickMultiSelect(list(PROCEDURE_TYPE_OPTIONS))
        main_group_lay.addWidget(self._quick_filter_box("Тип процедуры", self.cb_quick_trend, 190))
        self.cb_quick_status = QuickMultiSelect(list(STATUS_OPTIONS))
        main_group_lay.addWidget(self._quick_filter_box("Статус", self.cb_quick_status, 190))
        self.cb_quick_law = QuickMultiSelect([("44-ФЗ", "44"), ("223-ФЗ", "223")])
        main_group_lay.addWidget(self._quick_filter_box("Закон", self.cb_quick_law, 170))
        ...
        main_group_lay.addWidget(self._quick_filter_box("Дата публикации", self.cb_quick_published, 190))
        self.cb_browser = ChevronComboBox()
        self.cb_browser.setObjectName("QuickFilterCombo")
        self.cb_browser.setMinimumWidth(200)
        self.cb_browser.setMinimumHeight(44)
        self.cb_browser.setMaximumHeight(46)
