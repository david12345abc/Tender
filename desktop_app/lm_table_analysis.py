...
def build_technical_user_prompt(
    ...
    return (
        ...
        "Критически важно: не используй годы, даты, номера документов, номера ГОСТ/ТУ, футер сайта "
        "и служебные диапазоны вроде «2012-2026» как технические характеристики. "
        "Например, «2012-2026 м³/ч» из футера/копирайта — это не расход, а ошибка; в таком случае "
        "для flow_rate_or_range верни null.\n\n"
        "Поля JSON:\n"
        f"{fields}\n\n"
